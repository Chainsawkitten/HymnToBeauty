...
void ParticleEmitter::Load(const Json::Value& node) {
    ...
    particleType.minVelocity = Json::LoadVec3("minVelocity");
    particleType.maxVelocity = Json::LoadVec3("maxVelocity");
    particleType.minLifetime = node.get("minLifetime", 0.f).asFloat();
    particleType.maxLifetime = node.get("maxLifetime", 0.f).asFloat();
    particleType.minSize = Json::LoadVec2("minSize");
    particleType.maxSize = Json::LoadVec2("maxSize");
    ...
    particleType.color = Json::LoadVec3("color");
    size = Json::LoadVec3("size");
